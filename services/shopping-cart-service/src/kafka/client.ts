/**
 * @fileoverview Kafka producer for shopping-cart-service
...
const kafka = new Kafka({
  clientId: process.env.KAFKA_CLIENT_ID || "shopping-cart-service",
  brokers: (process.env.KAFKA_BROKERS || "localhost:9092").split(","),
  retry: { retries: 5 },
});

export const TOPICS = {
  SHOPPING_CART_EVENTS: "shopping_cart.events",
} as const;
